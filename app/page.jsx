...
export default function Home() {
  ...
  return (
    <main className="relative w-full overflow-x-hidden bg-canvas">
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/85 backdrop-blur-xl shadow-lg shadow-black/10' : 'bg-transparent'
        }`}>
