      ...
      <div className="px-[160px] py-[100px]">
        {event.id.includes("study-tour") && (
          <section className="tour_container">
            {/* Tour Header */}
            <div className="relative bg-cover bg-center h-[550px] mb-16 bg-slate-800 rounded-xl flex flex-col justify-center items-start text-white"
                 style={{ backgroundImage: "url('/assets/images/study-tour-bg.jpg')" }}>
              <div className="px-20">
                <h1 className="text-xl font-semibold mb-4 text-blue-400">{event.title}</h1>
                <h6 className="text-sm mb-2">{event.shortDescription}</h6>
                <h6 className="text-sm mb-6">
                  {event.date} | {event.location}
                </h6>
                <div className="mb-6">
                <Link href={`https://forms.gle/2r4NYYZwjVSLM5m37`}>
                    <button className="bg-white text-black px-4 py-2 rounded-[10px] font-bold text-[13px] flex items-center">
                      <Image src="/buttongo.png" alt="Register Icon" width={20} height={20} className="mr-2" />
            ...
            <div className="py-8 mb-16">
              <h1 className="text-xl font-bold text-center mb-10">INVITATION TO JOIN THE {event.title}</h1>
              <div className="flex flex-col md:flex-row md:items-center gap-12 mx-auto">
            ...
            {/* Why Attend Section */}
            <div className="py-20 px-16 bg-[#3a3a3a] rounded-[20px] mb-16 text-white">
              <div className=" mx-auto flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  <h3 className="text-[18px] font-bold mb-4">WHY ATTEND?</h3>
                  ...
                  <Link href={`https://forms.gle/2r4NYYZwjVSLM5m37`}>
                    <button className="bg-white text-black px-4 py-2 rounded-[10px] font-bold text-[13px] flex items-center">
                      <Image src="/buttongo.png" alt="Mouse Icon" width={20} height={20} className="mr-2" />
                      <span>Register Now</span>
                    </button>
                  </Link>
                </div>
                <div className="flex-1">
                  <h3 className="text-[18px] font-bold mb-4">Take advantage of the following:</h3>
                  {benefits.map((item, index) => (
                    <div key={index} className="flex items-center mb-2">
                      <Image src="/check.png" alt="Check Icon" width={30} height={30} className="mr-2" />
                      <h6 className='text-[13px]' dangerouslySetInnerHTML={{ __html: item }}></h6>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="py-8 mb-16">
              <h1 className="text-xl font-bold text-center mb-6">EVENT SCHEDULE</h1>
              <div className="flex items-center justify-center mb-4">
                <Image src="/meeting.png" alt="Meeting Point" width={35} height={35} className="mr-2" />
                <h1 className="text-xl font-bold">-  Meeting Point</h1>
              </div>
              <div className="mx-auto overflow-x-auto">
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-red-700 text-white text-[12px] text-left">
                      <th className="p-2 border">DATE</th>
                      <th className="p-2 border">ACTIVITY</th>
                      <th className="p-2 border">LOCATION(S)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {event.schedule && event.schedule.map((item, index) => (
                      <tr key={index} className="border-b text-[12px] font-semibold">
                              ...
                              {item.meetingPoint && (
                                <div className="mt-2">
                                  <span className="flex items-center">
                                    <Image src="/meeting.png" alt="meeting_point" width={35} height={35} className="mr-1" />
                                    {item.meetingPoint}
                                  </span>
                                </div>
                              )}
            ...
            <div className="py-8">
              <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 px-8">
                {/* Hotel Accommodation */}
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/hotel.png" alt="Hotel Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">HOTEL ACCOMMODATION</h1>
                  </div>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/transport.png" alt="Bus Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">TRANSPORTATION</h1>
                  </div>
                  <p className=' text-[12px]'>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/visa.png" alt="Visa Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">VISA</h1>
                  </div>
                  <p className=' text-[12px]'>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/registration.png" alt="Registration Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">REGISTRATION</h1>
                  </div>
                  <p className=' text-[12px]'>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/fee.png" alt="Fees Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">PARTICIPATION FEE</h1>
                  </div>
                  <p className=' text-[12px]'>The participation fee for a delegate per Institution for the {event.title} is as follows:</p>
                  <div className="mt-4 overflow-x-auto">
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-red-700 text-white text-[12px]">
                      ...
                      <tbody>
                        {fees.map((fee, idx) => (
                          <tr key={idx} className="border-b text-[10px]">
                            <td className="px-2 border">{fee.sn || (idx + 1)}</td>
                            <td className="px-2 border">{fee.city}</td>
                            <td className="px-2 border">{fee.fee}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  </div>
                  <p className="mt-4 text-[12px]"><strong>NB: {event.feesNote || "Additional delegate per Institution attracts an extra charge of 30% on fees."}</strong></p>
                </div>

                {/* Deadline */}
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/deadline.png" alt="Deadline Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">DEADLINE</h1>
                  </div>
                  <p className=' text-[12px]'>Kindly register on or before the <strong>{event.registerBy}</strong>.</p>

                  <div className="mt-4">
                    <h3 className="font-bold mb-2">Fee Covers:</h3>
                    {event.feesIncludes && event.feesIncludes.map((item, idx) => (
                      <p key={idx} className=' text-[12px]'>◉ {item}</p>
                    ))}

                    <h3 className="font-bold mt-4 mb-2">Fee <strong>DOES NOT</strong> Cover:</h3>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/payment.png" alt="Payment Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">PAYMENT</h1>
                  </div>
                  <p className=" mb-4 text-center text-[12px]">British AUC Bank Details</p>
                  <div className="space-y-1 text-[12px] text-center border p-4 rounded-[20px] font-semibold">
                    {event.bankDetails && (
                      <>
                ...
                <div className='rounded-[25px] shadow-md shadow-black px-10 py-6'>
                  <div className="flex items-center mb-4 justify-center">
                    <Image src="/terms.png" alt="Terms Icon" width={30} height={30} className="mr-2" />
                    <h1 className="text-[18px] font-bold">TERMS & CONDITIONS</h1>
                  </div>
                  <div className="space-y-2">
                    {event.termsConditions && event.termsConditions.map((term, idx) => (
                      <p key={idx} className=' text-[12px]'>◉ {term}</p>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mt-10">
              <div className="md:w-1/2">
                ...
                <div className="mt-6">
                  ...
                  <p className="text-gray-700 mb-4"><span className="font-semibold">Date:</span> {event.date}</p>
                  <p className="text-gray-700 mb-4"><span className="font-semibold">Location:</span> {event.location}</p>

                  <div className="my-6">
                    <p className="whitespace-pre-line">{event.detailedDescription}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:w-1/2">
                <div className="bg-gray-50 p-6 rounded-lg shadow-sm mb-6">
                  {event.benefits && event.benefits.length > 0 && (
                    <div className="mb-6">
                      <h3 className="text-lg font-bold mb-3">Benefits of Attending</h3>
                  ...
                  {event.contactPerson && (
                    <div id="registration" className="my-6 p-6 bg-blue-50 rounded-lg border border-blue-100">
                      <h3 className="text-lg font-bold mb-3">Registration Information</h3>
                      <p className="text-gray-700 mb-2"><span className="font-semibold">Register By:</span> {event.registerBy || "Contact for details"}</p>
                      <p className="text-gray-700 mb-2"><span className="font-semibold">Contact Person:</span> {event.contactPerson}</p>
                      <p className="text-gray-700 mb-2"><span className="font-semibold">Email:</span> {event.contactEmail}</p>
                      <p className="text-gray-700 mb-4"><span className="font-semibold">Phone:</span> {event.contactPhone}</p>

                      <button className="rounded-[10px] py-[10px] px-8 font-bold bg-blue-600 text-white text-[14px] hover:bg-blue-700 transition-colors">
                        Register for Event
                      </button>
                    </div>
                  )}
                  ...
                  <Link href="/events" className="inline-block">
                    <button className="rounded-[10px] py-[8px] px-8 font-bold bg-black text-white text-[14px] mt-4 hover:bg-gray-800 transition-colors">
                      Back to Events
                    </button>
                  </Link>
                </div>
